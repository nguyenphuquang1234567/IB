...
import { BUDGETING_CONCEPTS } from "@/lib/budgeting/concepts";
import { ChevronRight, AlertTriangle, BookOpen } from "lucide-react";
import { cn } from "@/lib/utils";

export default function BudgetingLearningPage() {
  const [expandedId, setExpandedId] = useState<string | null>("revenue");
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Core concepts for corporate budgeting and FP&A
        </p>
      </div>

      <div className="space-y-4">
        {BUDGETING_CONCEPTS.map((concept) => (
          <motion.div
            key={concept.id}
            layout
