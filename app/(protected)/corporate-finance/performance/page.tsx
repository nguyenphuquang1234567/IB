...
import { LineChart, BookOpen, BarChart3, Lightbulb, ChevronRight } from "lucide-react";
import { useCorporateFinanceStore } from "@/store/useCorporateFinanceStore";

const MODULES = [
  {
    href: "/corporate-finance/performance/learning",
    title: "Learning",
    desc: "Gross margin, operating margin, ROA, and ROIC. How analysts evaluate company performance.",
    icon: BookOpen,
    color: "from-blue-500 to-cyan-500",
  },
  {
    href: "/corporate-finance/performance/analyzer",
    title: "Performance Analyzer",
    desc: "Analyze financial data. Profitability trends, cost structure breakdown, and efficiency metrics.",
    icon: BarChart3,
    color: "from-emerald-500 to-teal-500",
  },
  {
    href: "/corporate-finance/performance/practice",
    title: "Practice",
    desc: "Financial calculations, data interpretation, and performance analysis questions.",
    icon: Lightbulb,
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <h1 className="text-2xl font-varela font-bold tracking-tight text-finstep-brown dark:text-foreground">
          Financial Performance Analysis Lab
        </h1>
        <p className="text-sm text-finstep-brown/60 dark:text-muted-foreground mt-1 max-w-xl mx-auto">
          Learn how analysts evaluate company performance. Gross margin, operating margin, ROA, ROIC, and performance trends.
        </p>
      </motion.div>
